...
import { ImageUpload } from "@/components/admin/store/utils/image-upload";
import { SizeFormSchema } from "@/schemas/admin/size-form-schema";

interface SizeFormProps {
  data: Size | null;
}

export const SizeForm = ({ data }: SizeFormProps) => {
